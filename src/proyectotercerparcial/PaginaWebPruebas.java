 ...
 * @author LAB01-PC24
 */
public class PaginaWebPruebas {

    private Scanner input;
    private Formatter salida;
    private String nombreArchivo = "";
    private ArrayList<Cancion> listaRegistroCanciones = new ArrayList<>();

    public PaginaWebPruebas(String nombreArchivo) {
    ...
    private void escribirPaginaWeb() {
        ...
        salida.format("<h1>Canciones Disponibles</h1>\n");
        ...
        for (Cancion aux : listaRegistroCanciones) {
            salida.format("<tr>\n");
