...
public class PaginaWebCompras {
    ...
    public PaginaWebCompras(String nombreArchivo) {
    ...
    private void escribirPaginaWeb() {
        ...
        salida.format("<h1>Canciones Compradas</h1>\n");
        ...
        for (Cancion aux : listaCancionesCompradas) {
            ...
            salida.format("<td>%s</td>\n", aux.getAlbum());
            salida.format("<td><audio src=\'CancionesCompletas/" + aux.getArchivo() + ".mp3'\' controls>\n" + "</audio></td>\n");
            //salida.format("<td>%s</td>\n", aux.getArchivo());
